...
const roleChipCls: Record<string, string> = {
  ...
  approver: "bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400",
          ...
          {loading ? (
            ...
            <>
              <div className="rounded-lg border border-gray-100 dark:border-slate-800 overflow-hidden">
                ...
                <div className="flex items-center justify-between px-3 py-2 gap-3 border-b border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-900/50">
                  <div className="flex items-center gap-2 min-w-0">
                    <Crown size={12} className="text-amber-500 shrink-0" />
                    <span className="text-xs text-gray-500 dark:text-slate-400">Owner</span>
                  </div>
                  ...
                  >
                    ...
                    {isOwner && (
                      <button
                        ...
                        className="rounded p-1 text-gray-300 dark:text-slate-600 hover:text-red-500 dark:hover:text-red-400 disabled:opacity-40 transition-colors shrink-0"
                        title="Remove access"
                      >
                        <Trash2 size={13} />
                      </button>

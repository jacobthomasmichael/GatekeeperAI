...
export default function SubmitPage() {
  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-white">Submit an App</h1>
      ...
      >
        ...
        <div className="space-y-1.5">
          ...
          />
          <p className="text-xs text-slate-600">Letters, numbers, hyphens, underscores</p>
        </div>
      ...
      <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-4 text-sm text-slate-500 space-y-2">
        <p className="font-medium text-slate-400">What happens next?</p>
        <ol className="list-decimal list-inside space-y-1">
          <li>A bare git repository is created for your app</li>
          <li>Push your code with <code className="text-slate-300">git push</code></li>

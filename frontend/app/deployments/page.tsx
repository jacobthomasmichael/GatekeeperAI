    ...
    <div className="max-w-5xl space-y-6">
      ...
      {!loading && deployments.length === 0 && (
        <div className="rounded-xl border border-dashed border-slate-700 bg-slate-900/50 p-12 text-center">
          ...
          <h3 className="text-sm font-medium text-slate-300">No deployments</h3>
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                {d.image_tag && (
                  <p className="text-xs text-slate-600 mt-1">{d.image_tag}</p>
                )}
            ...
            {/* Logs panel */}
            {logs[d.id] !== undefined && (
              <div className="rounded-lg bg-slate-950 border border-slate-800 p-3 max-h-48 overflow-y-auto">
